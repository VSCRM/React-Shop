...
const p1 = { productId: 'p1', quantity: 1, estimatedDeliveryTimeMs: 0, product: { id: 'p1', name: 'Shirt', image: '', priceCents: 0, rating: { stars: 4, count: 1 } } } as OrderProduct;
const p2 = { productId: 'p2', quantity: 1, estimatedDeliveryTimeMs: 0, product: { id: 'p2', name: 'Pants', image: '', priceCents: 0, rating: { stars: 4, count: 1 } } } as OrderProduct;
const p1dup = { productId: 'p1', quantity: 1, estimatedDeliveryTimeMs: 0, product: { id: 'p1', name: 'Shirt (duplicate)', image: '', priceCents: 0, rating: { stars: 4, count: 1 } } } as OrderProduct;
